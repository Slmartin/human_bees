...
\begin{figure}[ht!]
\begin{centering}
\includegraphics[scale=0.4]{figures/Figure7.png}\caption{Impact of disturbance on stimulus.}
\label{fig:figure3}
\par\end{centering}
